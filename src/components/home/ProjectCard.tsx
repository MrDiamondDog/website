    ...
    return (
        <a
            ...
            className={`no-style rounded-lg bg-bg-lighter p-3 pb-8 relative 
                transition-all border-[2px] hover:border-primary ${props.highlight ? "border-primary" : "border-transparent"}`}
        >
            ...
            <div className="flex flex-row gap-2 items-center absolute bottom-3">
                ...
                <div className="flex flex-row gap-1 items-center">
                    ...
                    <p className="text-sm">{numberWithCommas(repo.stargazers_count)}</p>
                </div>
            </div>
        </a>
    );
