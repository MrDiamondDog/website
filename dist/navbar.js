...
navbar.innerHTML = `
    ...
    <a class="nav-item" id="gen-dropdown">Generators<span class="material-symbols-outlined dropdown">expand_more</span></a>
...
googleFonts.href = "https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200";
document.head.appendChild(googleFonts);
function dropdown(dropdownId, dropdownContentId) {
